...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "@ikwtbot"
...
async def amireallyalive(alive):
    ...
    with BytesIO() as sticker:
        ...
        sticker.seek(0)
        await borg.send_message(alive.chat_id, f"**مرحباَ بك في تليثون **\n\n"
